...
description: Version 1.8.0 brings ARC-200 support as well as many quality of life fixes.
...
Although there is a lot of talk about ARC-200, let us not forget one of the most powerful features of AVM: Standard Assets. These assets are baked into the very heart of the AVM protocol and are feature that make AVM chains some of the best in class.

The new version of Kibisis allow you to opt-in to standard assets, using an opt-in transaction, which, at the time of writing will cost you 0.01; the standard fee amount.
