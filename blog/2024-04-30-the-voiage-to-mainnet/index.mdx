...
The Voiage to mainnet is nearly complete and, as a user of Kibisis, you have been part of this extraordinary journey so far. Therefore, we at Kibisis would like to cordially invite you to undertake a few quests to earn rewards that will be redeemable once we enter Voi mainnet.
...
* Send some VOI to another account
* Sending some VIA (or any ARC-0200 asset) to another account
* Sending some standard asset to another account
* Acquiring an NFT
* ... and more!
...
<BlogScreenshotImage
  label="Allow action tracking from provacy settings"
  maxWidth="400px"
  imageSources={{
