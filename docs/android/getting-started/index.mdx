...
We currently do not have an app in the F-Droid store, but we are working hard make it available.
...
Direct downloads of the APK is **NOT RECOMMENDED** for most Android users. Please ensure that you verify the APK is signed by the below [signature](#verify-the-apk-optional). Also note that the key used to sign the Google Play Store app is different to the key used to sign the deirect download APK. The Google Play Store signing key is maintained by Google.
